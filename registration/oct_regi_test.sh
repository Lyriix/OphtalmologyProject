...
###########
RIGIDCONVERGENCE="[20,1e-5,10]"
RIGIDSHRINKFACTORS="1"
RIGIDSMOOTHINGSIGMAS="0vox"

AFFINECONVERGENCE="[20,1e-5,10]"
AFFINESHRINKFACTORS="1"
AFFINESMOOTHINGSIGMAS="0vox"

SYNCONVERGENCE="[20,1e-5,10]"
SYNSHRINKFACTORS="1"
SYNSMOOTHINGSIGMAS="0vox"
...
do
    ...
    OUTPUTNAME="../result_test/Translation/${i+2}to1"
...
do
    ...
    OUTPUTNAME="../result_test/Rigid/${i+2}to1"
    echo "Registration for '${MOVINGIMAGES[$i]}' to target '${FIXEDIMAGE[0]}'"
...
do
    ...
    STAGES="$INITIALSTAGE $AFFINESTAGE"
    
    OUTPUTNAME="../result_test/Affine/${i+2}to1"
    echo "Registration for '${MOVINGIMAGES[$i]}' to target '${FIXEDIMAGE[0]}'"
...
do
    ...
    OUTPUTNAME="../result_test/Diffeomorphic/${i+2}to1"
    echo "Registration for '${MOVINGIMAGES[$i]}' to target '${FIXEDIMAGE[0]}'"
